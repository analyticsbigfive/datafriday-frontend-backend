# BUG-151 — `TaxonomyImportDrawer.vue` : la FK parente (type/catégorie) n'est jamais forcée avant l'import, chaque ligne échoue silencieusement en 400 brut si elle est absente
