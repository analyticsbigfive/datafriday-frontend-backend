# BUG-158 — EventPredict : cascade historique de versions dupliquées, tenue par des workarounds fragiles
...
- Backend BUG-13/76 (famille intégrité EventPredictVersion), backend BUG-86
