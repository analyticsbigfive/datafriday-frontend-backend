# BUG-197 — Analyse / Prédire : aucune configuration pré-sélectionnée (union « All » coûteuse) + contexte PdV dispatché deux fois
...
2. Le donut « Par zone » reste vide pendant tout ce différé (cf.
   [BUG-195](195_analyse_donut_zone_vide_pendant_contexte_differe.md)) : `shopArea` vient des
...
- [BUG-195](195_analyse_donut_zone_vide_pendant_contexte_differe.md) — donut « Par zone » et
