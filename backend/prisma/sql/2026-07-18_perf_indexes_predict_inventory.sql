...
--
-- Sûr et additif : CREATE INDEX IF NOT EXISTS, aucun impact données.
-- Rejouable.

CREATE INDEX IF NOT EXISTS "EventPredictVersion_tenantId_eventId_idx"
  ON "EventPredictVersion" ("tenantId", "eventId");

CREATE INDEX IF NOT EXISTS "InventoryCount_tenantId_spaceId_updatedAt_idx"
