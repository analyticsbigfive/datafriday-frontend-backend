# BUG-182 — Scoring predict entièrement client-side : 3-8s de calcul, incompatible avec un rendu < 300ms
...
- Fiche 180 ; commentaires `[perf]` dans `analyse.js:2150`
