# BUG-168 — `EventsSubcategorieListView.vue exportToCSV` : colonne "Event Category" systématiquement vide
...
**toutes** les lignes, pas seulement celles ajoutées récemment — indépendant du bug BUG-167
ci-dessus.
...
- `docs/bugs/167_taxonomie_evenements_optimistic_write_objets_partiels.md` (même écran, bug
