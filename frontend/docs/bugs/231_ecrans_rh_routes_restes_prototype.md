# BUG-231 — Écrans RH routés : restes de prototype désormais visibles (crashs dialog/CSV, backend mort, bouton Profile, N+1, textes hors i18n)
...
- [BUG-229](229_props_double_majuscule_liaison_kebab_morte.md), [BUG-230](230_consolidated_views_double_navigation_onclose.md)
