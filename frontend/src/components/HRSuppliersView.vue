...
// (BUG-203). Retours non bloquants via console en attendant la refonte.
const toast = {
...
export default {
  ...
  data() {
    return {
      ...
      // crashait à l'ouverture du dialog (BUG-203).
      SECTORS,
  ...
  methods: {
    async loadData() {
      try {
        ...
        // en série, BUG-203) ; un échec par espace retombe sur [].
