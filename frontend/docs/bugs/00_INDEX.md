...
J+1 activable sur un event pas terminé). Point laissé ouvert (BUG-305-02) : le badge ● LIVE est basé
sur la route, pas sur la détection réelle d'un event dans la fenêtre de 30 min.
