...
.ntd-grad-header__title { font-size:16px; font-weight:700; color:#fff; }
.ntd-grad-header__sub { font-size:12px; color:rgba(255,255,255,.75); margin-top:2px; }
...
.ntd-error { display:flex; align-items:center; gap:7px; background:#fef2f2; border:1px solid #fecaca; color:#991b1b; border-radius:10px; padding:10px 14px; font-size:13px; margin-bottom:16px; }
.ntd-input { border:1.5px solid #e5e7eb !important; border-radius:11px !important; box-shadow:none !important; height:52px; font-size:14px; }
...
.ntd-btn { display:inline-flex; align-items:center; gap:6px; padding:0 20px; height:40px; border-radius:50px; font-size:13.5px; font-weight:600; cursor:pointer; border:none; transition:all .2s; }
