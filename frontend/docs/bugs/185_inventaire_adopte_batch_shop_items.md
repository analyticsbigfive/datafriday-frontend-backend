# BUG-185 — (miroir) Space Inventory : adoption du batch shop-items (fin du N+1 par shop)

- **Statut** : 🟢 Corrigé (2026-07-18)
- **Sévérité** : 🟠 Majeur/perf (rendu initial Space Inventory)
- **Domaine** : Stock (Inventory)
- **Repo(s) concerné(s)** : les deux — **fiche canonique : `api-datafriday-staging/docs/bugs/96_shop_items_batch_incomplet_n1_inventaire.md`**
...
- `api-datafriday-staging/docs/bugs/96_shop_items_batch_incomplet_n1_inventaire.md` (canonique), backend BUG-010
