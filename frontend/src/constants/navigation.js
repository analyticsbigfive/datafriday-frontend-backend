    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { title: 'navMarketPriceTypes', route: '/market-price-types', permission: 'menu.config.manage' },
          { title: 'navMarketPriceCategories', route: '/market-price-categories', permission: 'menu.config.manage' },
          { title: 'navComponentTypes', route: '/component-types', permission: 'menu.config.manage' },
          { title: 'navComponentCategories', route: '/component-categories', permission: 'menu.config.manage' },
          { title: 'navBrandNames', route: '/brand-names', permission: 'menu.config.manage' },
          { title: 'navDisplayNames', route: '/display-names', permission: 'menu.config.manage' },
          { title: 'navIndustrials', route: '/industrials', permission: 'menu.config.manage' },
          { title: 'navPackingTypes', route: '/packing-types', permission: 'menu.config.manage' },
        ],
      },
    ],
    standalone: [
