# BUG-150 — `getSpaceEventTimelineBatch` : registre in-flight jamais nettoyé sur échec → erreurs permanentes
...
- Fiche 157 (le moteur predict s'appuie désormais sur ce batch — ce fix était un prérequis)
