# BUG-163 — EventPredict : la date périmée d'un snapshot/brouillon écrase la date canonique → l'event disparaît du calendrier
...
- Famille intégrité versions EventPredict : fiches 157, 158.
