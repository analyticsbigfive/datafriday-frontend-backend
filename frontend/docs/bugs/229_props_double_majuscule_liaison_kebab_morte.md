# BUG-229 — Props à double majuscule (`onOpenHR`, `onOpenFBIntegration`) : la liaison kebab-case ne matche jamais, câblage silencieusement mort
...
- [BUG-230](230_consolidated_views_double_navigation_onclose.md) (second piège découvert au même branchement)
