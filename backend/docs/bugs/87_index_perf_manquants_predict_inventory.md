# BUG-87 — Index manquants : EventPredictVersion (tenantId,eventId) et InventoryCount (tenantId,spaceId,updatedAt)
...
- Fiche 81 (autre changement d'index InventoryCount, distinct)
