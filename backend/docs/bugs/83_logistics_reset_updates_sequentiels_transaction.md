# BUG-83 — `reset` logistique : updates StockLevel un-par-un dans la transaction 30s
...
Parité valeurs : `packedUnits` Int (trunc), `looseUnits` float8. La fenêtre de course documentée du reset (`:1256-1259`) est inchangée (voir fiche 90). Vérifier en staging un reset sur espace réel : mêmes niveaux résultants, durée transaction en forte baisse.

## Références

- Fiche 90 (race reset / simulateSale, ⚪)
