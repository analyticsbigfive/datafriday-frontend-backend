...
| [234](234_pre_event_reconciliation_lignes_orphelines_sans_nom.md) | Réconciliation pré-événement : lignes « — » = comptages orphelins pointant vers des articles/PdV supprimés (ids cuid absents après ré-import catalogue UUID) ; exclusion des lignes + nettoyage SQL des `InventoryCount` orphelins | 🟡 Corrigé non déployé | 🟠 | Stock |
