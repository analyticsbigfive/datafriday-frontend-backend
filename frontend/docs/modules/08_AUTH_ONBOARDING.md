...
| 9 | ~~`console.log` du JWT en clair à l'onboarding~~ — **corrigé le 2026-07-18**, voir [BUG-191](../bugs/191_auth_console_log_jwt_en_clair.md) | 🟢 Corrigé | `store/modules/auth.js:351` (avant correction) | — |
