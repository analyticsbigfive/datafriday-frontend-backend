# BUG-198 — Chargement Analyse : catalogues globaux fetchés en double + phase 2 monolithique + contexte PdV sans cache
...
remonte AnalyseView → `loadSpace` → refetch. (BUG-197 avait refusé une dédup « déjà chargé »
...
- [BUG-197](197_analyse_predict_config_par_defaut_et_dedup_contexte.md) — la pré-sélection d'une
