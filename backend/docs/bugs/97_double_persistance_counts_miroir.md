# BUG-97 — (miroir) Double persistance des comptages : POST par item + snapshot blob
...
- **Repo(s) concerné(s)** : les deux — **fiche canonique : `datafriday-web/docs/bugs/183_double_persistance_comptages.md`**
...
Voir fiche canonique front 183. Choix du chemin d'écriture canonique = décision d'architecture liée à BUG-93/82 → `docs/QUESTIONS_A_BERTRAND.md`. Rien n'a été débranché dans cette session.

## Références

- `datafriday-web/docs/bugs/183_double_persistance_comptages.md`, BUG-93, BUG-94
