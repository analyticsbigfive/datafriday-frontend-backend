# BUG-199 — `shop-items` : 5,6 Mo / 53 s, une photo base64 réémise une fois par PdV
...
[BUG-195](195_analyse_donut_zone_vide_pendant_contexte_differe.md)).
...
**course**. Depuis le découpage de la phase 2 ([BUG-198](198_chargement_analyse_dedup_catalogues_et_phase2_en_vagues.md)),
...
- [BUG-195](195_analyse_donut_zone_vide_pendant_contexte_differe.md) — le skeleton du donut
