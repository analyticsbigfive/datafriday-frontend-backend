# BUG-79 — `getMenuKpis`/`getEventKpis` : findMany du tenant entier + agrégation JS
...
- `getEventKpis` : 1 requête single-pass (+ scoping `spaceId` optionnel, cf. BUG-77).
