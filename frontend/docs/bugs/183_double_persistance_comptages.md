# BUG-183 — Inventaire : chaque comptage écrit deux fois (POST par item + snapshot blob)
...
- **Repo(s) concerné(s)** : les deux (canonique ici ; miroir `api-datafriday-staging/docs/bugs/97_double_persistance_counts_miroir.md`)
...
- Backend BUG-93, BUG-94, miroir 97
