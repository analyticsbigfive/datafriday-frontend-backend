...
**43 bugs au total**, extraits de `datafriday-web/docs/modules/` (source exhaustive, ~61 bugs
recensés dont certains purement frontend — voir l'index miroir) le 2026-07-15.
