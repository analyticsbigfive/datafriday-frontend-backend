...
- **Domaine** : (module métier concerné — voir `../CARTOGRAPHIE_MODULES.md`)
- **Repo(s) concerné(s)** : `datafriday-web` | `api-datafriday-staging` | les deux
- **Découvert le** : YYYY-MM-DD
- **Fichiers** : `chemin/fichier.vue:ligne` (si connu)
