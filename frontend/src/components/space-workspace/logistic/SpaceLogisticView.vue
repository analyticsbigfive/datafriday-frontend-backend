...
import LogisticTransferConfirmDrawer from '@/components/space-workspace/logistic/LogisticTransferConfirmDrawer.vue'
import LogisticLossesDrawer from '@/components/space-workspace/logistic/LogisticLossesDrawer.vue'
import LogisticHistoryDrawer from '@/components/space-workspace/logistic/LogisticHistoryDrawer.vue'
