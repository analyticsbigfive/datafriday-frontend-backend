...
> métier (§ 9), exemple live Auxerre (§ 10), bug [194](../bugs/194_inventory_reconciliation_fallback_plus_vieux_match.md)
...
- Consommateurs recensés : Réarmement (ci-dessus) et mode Predict d'Analyse
  (fiche [193](../bugs/193_predict_vues_article_absentes_grain_shop_level.md)). La réconciliation
...
bug [194](../bugs/194_inventory_reconciliation_fallback_plus_vieux_match.md) corrigé le
...
| Pre-event = prochain match, Post-event = dernier fini | pre : futur strict ; post : contexte passé sinon dernier passé ([SpaceInventoryView.vue:1379-1402](../../src/views/SpaceInventoryView.vue)) — fallback corrigé (bug [194](../bugs/194_inventory_reconciliation_fallback_plus_vieux_match.md)) | ✅ après fix |
