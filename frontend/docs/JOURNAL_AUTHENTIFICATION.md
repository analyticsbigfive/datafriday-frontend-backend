...
|---|---|---|---|---|---|
| 2026-07-18 | 14:31–14:40 | emmanuel | Correctif | [BUG-190](bugs/190_auth_signed_out_rotation_deconnexion_multi_onglets.md) — déconnexion multi-onglets sur rotation du refresh token | 🟢 Corrigé |
| 2026-07-18 | 14:34 | emmanuel | Correctif | [BUG-191](bugs/191_auth_console_log_jwt_en_clair.md) — JWT imprimé en clair dans la console | 🟢 Corrigé |
...
| 2026-07-18 | 17:57 | emmanuel | **Correctif de régression** | Interblocage du `signOut()` introduit par la 1ʳᵉ version de BUG-190 | 🟢 Corrigé, vérifié au navigateur |
| 2026-07-18 | 18:59 | emmanuel | Documentation | Création de [`AMELIORATIONS_AUTHENTIFICATION.md`](AMELIORATIONS_AUTHENTIFICATION.md) | ✅ |
| 2026-07-18 | 18:59 | emmanuel | Nettoyage | [BUG-192](bugs/192_auth_code_mort_login_onboarding_guards.md) — suppression du code mort du domaine | 🟢 Corrigé |
...
## [2026-07-18 14:31–14:40] — emmanuel — Correctif — BUG-190 : déconnexion intempestive multi-onglets
...
## [2026-07-18 14:34] — emmanuel — Correctif — BUG-191 : JWT en clair dans la console
...
**Cause — régression introduite par la première version du correctif BUG-190 (14:40).**
...
## [2026-07-18 18:59] — emmanuel — Nettoyage — BUG-192 : suppression du code mort du domaine
...
**Conséquence sur les statuts** — [BUG-190](bugs/190_auth_signed_out_rotation_deconnexion_multi_onglets.md)
...
**Vérification navigateur** (bloquant pour passer BUG-190 en 🟢)
